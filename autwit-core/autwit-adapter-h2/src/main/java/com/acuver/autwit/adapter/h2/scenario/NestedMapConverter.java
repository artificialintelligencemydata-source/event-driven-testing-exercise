...
/**
 * JPA Converter for Map<String, Map<String, String>>
 * Converts nested Map to JSON string for database storage
 */
@Slf4j
@Converter
public class NestedMapConverter implements AttributeConverter<Map<String, Map<String, String>>, String> {
    ...
    public String convertToDatabaseColumn(Map<String, Map<String, String>> attribute) {
        ...
        try {
            ...
            log.error("Error converting Map<String, Map<String, String>> to JSON", e);
            return "{}";
        }
    }
    ...
    public Map<String, Map<String, String>> convertToEntityAttribute(String dbData) {
        ...
        try {
            ...
            log.error("Error converting JSON to Map<String, Map<String, String>>", e);
            return new HashMap<>();
        }
    }
}