 ...
 * Converts Map<String, Map<String, String>> to JSONB in PostgreSQL
 */

@Converter
public class NestedMapConverter implements AttributeConverter<Map<String, Map<String, String>>, String> {
    private static final Logger log = LogManager.getLogger(NestedMapConverter.class);
    ...
    public String convertToDatabaseColumn(Map<String, Map<String, String>> attribute) {
        ...
        try {
            ...
            log.error("Error converting Map<String, Map<String, String>> to JSON for PostgreSQL", e);
            return "{}";
        }
    }
    ...
    public Map<String, Map<String, String>> convertToEntityAttribute(String dbData) {
        ...
        try {
            ...
            log.error("Error converting JSON to Map<String, Map<String, String>> from PostgreSQL", e);
            return new HashMap<>();
        }
    }
}